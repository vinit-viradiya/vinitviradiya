!(function(i) {
    ...
    (e.prototype.applyTransition = function(i) {
        ...
        !1 === e.options.fade ?
            ...
            (t[e.transitionType] = "opacity " + e.options.speed + "ms " + e.options.cssEase), !1 === e.options.fade ? e.$slideTrack.css(t) : e.$slides.eq(i).css(t);
    }),
    ...
    (e.prototype.cleanUpEvents = function() {
        ...
        e.options.dots &&
            ...
            (i("li", e.$dots)
                ...
                .off("mouseleave.slick", i.proxy(e.interrupt, e, !1)), !0 === e.options.accessibility && e.$dots.off("keydown.slick", e.keyHandler)),
    ...
    (e.prototype.setupInfinite = function() {
        ...
        if (
            ...
            for (
                o = !0 === s.options.centerMode ? s.options.slidesToShow + 1 : s.options.slidesToShow, e = s.slideCount; e > s.slideCount - o; e -= 1
            )
                (t = e - 1),
                i(s.$slides[t])
                .clone(!0)
        ...
        return (
            ...
            ((e = l.getLeft(l.currentSlide)),
                ...
                (!0 === l.options.verticalSwiping && (l.touchObject.swipeLength = r),
                    ...
                    ((o = l.touchObject.swipeLength * l.options.edgeFriction), (l.touchObject.edgeHit = !0)), !1 === l.options.vertical ? (l.swipeLeft = e + o * s) : (l.swipeLeft = e + o * (l.$list.height() / l.listWidth) * s), !0 === l.options.verticalSwiping && (l.swipeLeft = e + o * s), !0 !== l.options.fade &&

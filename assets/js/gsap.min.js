...
!(function(t, e) {
                ...
                if ((this !== I && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)) {
                    if (
                        ...
                        if (
                            ((i = ja(v % o)),
                                ...
                                (d = Tt(this._tTime, o)), !_ && this._tTime && d !== s && this._tTime - d * o - this._dur <= 0 && (d = s),
                                c && 1 & s && ((i = g - i), (p = 1)),
                                s !== d && !this._lock)
                        ) {
                            var T = c && 1 & d,
                    ...
                    if (
                        (this._hasPause &&
                            ...
                            (this._act = !l),
                            this._initted ||
                            ((this._onUpdate = this.vars.onUpdate), (this._initted = 1), (this._zTime = t), (_ = 0)), !_ && i && !e && !s && (Ct(this, "onStart"), this._tTime !== v))
                    )
                        return this;
                    if (_ <= i && 0 <= t)
                        for (n = this._first; n;) {
                    ...
                    this._onUpdate && !e && Ct(this, "onUpdate", !0),
                        ...
                        ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                            ...
                            ((!t && g) || !((v === m && 0 < this._ts) || (!v && this._ts < 0)) || za(this, 1),
                                ...
                                (t < 0 && !_) ||
                                (!v && !_ && m) ||
                                (Ct(this, v === m && 0 <= t ? "onComplete" : "onReverseComplete", !0), !this._prom || (v < m && 0 < this.timeScale()) || this._prom())));
                }
                return this;
            }),
            ...
            if (
                (r(n) &&
                    (~n.indexOf("random(") && (n = ob(n)),
                        "=" === n.charAt(1) && ((!(d = ka(p, n) + (Ya(p) || 0)) && 0 !== d) || (n = d))), !f || p !== n || Gt)
            )
                return isNaN(p * n) || "" === n ?
                    (c || e in t || Q(e, n),
        ...
        Qt = function _initTween(t, e, r) {
            ...
            if (
                (!D || (O && g) || (g = "none"),
                    ...
                    (t._from = !D && !!m.runBackwards), !D || (O && !m.stagger))
            ) {
                if (
    ...
    var $t = (function(D) {
        function Tween(e, r, i, n) {
            ...
            if (
                ...
                if (
                    ...
                    for (o = 0; o < h; o++)
                        ...
                        (u.delay = (+Kt(m, _assertThisInitialized(a), o, f, C) || 0) - a._delay), !T && 1 === h && u.delay && ((a._delay = m = u.delay), (a._start += m), (u.delay = 0)),
            ...
            return (!0 !== b || F || ((Nt = _assertThisInitialized(a)), I.killTweensOf(C), (Nt = 0)),
                    ...
                    (i ?
                        (function() {
                            ...
                            for (
                                ...
                                .map(function(t) {
                                    return {
                                        g: t._dur || t._delay || (t._sat && !t._sat.vars.immediateRender) ?
                                            t.globalTime(0) :
                                            -1 / 0,
                                        t: t,
                                    };
    ...
    function Vd(e) {
        ...
        return (
            (r && (r.width || r.height)) || i || (r = Td(e)), !r || r.width || r.x || r.y ?
            r :
            {
                x: +Ud(e, ["x", "cx", "x1"]) || 0,
                y: +Ud(e, ["y", "cy", "y1"]) || 0,
